...
## Project Structure
    ...
    ├── testapiautoconnecto_93133  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_93133`
...
2. Clone this repo and `cd testapiautoconnecto_93133`
